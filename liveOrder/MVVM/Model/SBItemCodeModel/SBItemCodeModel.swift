...
public final class SBItemCodeModel: NSCoding {
  ...
  public var payloadJson: SBItemCodePayloadJson?
  ...
  public required init(json: JSON) {
    ...
    payloadJson = SBItemCodePayloadJson(json: json[SerializationKeys.payloadJson])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? SBItemCodePayloadJson
