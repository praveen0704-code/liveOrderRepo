...
public final class OrderSellerList: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: OSPayloadJson?
  public var headers: OSHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = OSPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = OSHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? OSPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? OSHeaders
