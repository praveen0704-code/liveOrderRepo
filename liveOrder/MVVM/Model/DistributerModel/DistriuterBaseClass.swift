...
public final class DistriuterBaseClass: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: DistributerPayloadJson?
  public var headers: DistributerHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = DistributerPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = DistributerHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? DistributerPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? DistributerHeaders
