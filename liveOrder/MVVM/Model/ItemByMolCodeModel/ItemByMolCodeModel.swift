...
public final class ItemByMolCodeModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: ItemByMolCodePayloadJson?
  public var headers: ItemByMolCodeHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = ItemByMolCodePayloadJson(json: json[SerializationKeys.payloadJson])
    headers = ItemByMolCodeHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? ItemByMolCodePayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? ItemByMolCodeHeaders
