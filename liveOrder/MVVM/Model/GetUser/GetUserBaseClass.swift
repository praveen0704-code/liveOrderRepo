//
//  GetUserBaseClass.swift
//
//  Created by PraveenMac on 01/02/22
...
public final class GetUserBaseClass: NSCoding {
  ...
  // MARK: Properties
  public var headers: GetUserHeaders?
  ...
  public required init(json: JSON) {
    headers = GetUserHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? GetUserHeaders
