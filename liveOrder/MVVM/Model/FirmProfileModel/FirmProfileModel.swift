...
public final class FirmProfileModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: FirmProfilePayloadJson?
  public var headers: FirmProfileHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = FirmProfilePayloadJson(json: json[SerializationKeys.payloadJson])
    headers = FirmProfileHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? FirmProfilePayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? FirmProfileHeaders
