...
public final class BranchListBaseClass: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: BranchListPayloadJson?
  public var headers: BranchListHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = BranchListPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = BranchListHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? BranchListPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? BranchListHeaders
