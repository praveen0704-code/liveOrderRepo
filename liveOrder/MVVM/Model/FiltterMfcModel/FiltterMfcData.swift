...
public final class FiltterMfcData: NSCoding {
  ...
  // MARK: Properties
  public var jList: [FiltterMfcJList]?
  ...
  public required init(json: JSON) {
    if let items = json[SerializationKeys.jList].array { jList = items.map { FiltterMfcJList(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    self.jList = aDecoder.decodeObject(forKey: SerializationKeys.jList) as? [FiltterMfcJList]
