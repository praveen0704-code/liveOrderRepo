...
public final class FiltterMfcModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: FiltterMfcPayloadJson?
  public var headers: FiltterMfcHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = FiltterMfcPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = FiltterMfcHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? FiltterMfcPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? FiltterMfcHeaders
