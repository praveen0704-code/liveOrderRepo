...
//
//  Created by Data Prime on 15/11/21
...
public final class SearchProductModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: SearchProductModelPayloadJson?
  public var headers: SearchProductModelHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = SearchProductModelPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = SearchProductModelHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? SearchProductModelPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? SearchProductModelHeaders
