...
public final class SearchProductModelData: NSCoding {
  ...
  // MARK: Properties
  public var jList: [SearchProductModelJList]?
  ...
  public required init(json: JSON) {
    if let items = json[SerializationKeys.jList].array { jList = items.map { SearchProductModelJList(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    self.jList = aDecoder.decodeObject(forKey: SerializationKeys.jList) as? [SearchProductModelJList]
