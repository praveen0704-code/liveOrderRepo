...
public final class SearchProductModelJList: NSCoding {
  ...
  private struct SerializationKeys {
    ...
    static let nQtyPerBox = "n_qty_per_box"
    ...
    static let cContainName = "c_contains"
  ...
  public required init(json: JSON) {
    ...
    nQtyPerBox = json[SerializationKeys.nQtyPerBox].int
  ...
  public func dictionaryRepresentation() -> [String: Any] {
    ...
    if let value = nQtyPerBox { dictionary[SerializationKeys.nQtyPerBox] = value }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.nQtyPerBox = aDecoder.decodeObject(forKey: SerializationKeys.nQtyPerBox) as? Int
  ...
  public func encode(with aCoder: NSCoder) {
    ...
    aCoder.encode(nQtyPerBox, forKey: SerializationKeys.nQtyPerBox)
