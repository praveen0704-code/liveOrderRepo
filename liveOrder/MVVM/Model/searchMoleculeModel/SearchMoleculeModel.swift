...
public final class SearchMoleculeModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: searchMoleculePayloadJson?
  public var headers: searchMoleculeHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = searchMoleculePayloadJson(json: json[SerializationKeys.payloadJson])
    headers = searchMoleculeHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? searchMoleculePayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? searchMoleculeHeaders
