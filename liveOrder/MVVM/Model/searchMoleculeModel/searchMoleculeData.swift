...
public final class searchMoleculeData: NSCoding {
  ...
  // MARK: Properties
  public var jList: [searchMoleculeJList]?
  ...
  public required init(json: JSON) {
    if let items = json[SerializationKeys.jList].array { jList = items.map { searchMoleculeJList(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    self.jList = aDecoder.decodeObject(forKey: SerializationKeys.jList) as? [searchMoleculeJList]
