...
public final class SBCountModel: NSCoding {
  ...
  public var payloadJson: SBCountPayloadJson?
  ...
  public required init(json: JSON) {
    ...
    payloadJson = SBCountPayloadJson(json: json[SerializationKeys.payloadJson])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? SBCountPayloadJson
