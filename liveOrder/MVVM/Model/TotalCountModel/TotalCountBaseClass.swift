...
public final class TotalCountBaseClass: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: TPayloadJson?
  public var headers: THeaders?
  ...
  public required init(json: JSON) {
    payloadJson = TPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = THeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? TPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? THeaders
