...
public final class WLCountModel: NSCoding {
  ...
  public var payloadJson: WLCountPayloadJson?
  ...
  public required init(json: JSON) {
    ...
    payloadJson = WLCountPayloadJson(json: json[SerializationKeys.payloadJson])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? WLCountPayloadJson
