...
public final class PDPModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: PDPPayloadJson?
  public var headers: PDPHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = PDPPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = PDPHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? PDPPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? PDPHeaders
