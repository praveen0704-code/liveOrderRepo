...
//
//  Created by Data Prime on 16/12/21
...
public final class CartCountModel: NSCoding {
  ...
  public var payloadJson: CartCountPayloadJson?
  ...
  public required init(json: JSON) {
    ...
    payloadJson = CartCountPayloadJson(json: json[SerializationKeys.payloadJson])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? CartCountPayloadJson
