...
public final class MpdSellerModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: MpdSellerPayloadJson?
  public var headers: MpdSellerHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = MpdSellerPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = MpdSellerHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? MpdSellerPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? MpdSellerHeaders
