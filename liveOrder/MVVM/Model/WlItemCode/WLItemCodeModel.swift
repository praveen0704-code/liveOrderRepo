...
public final class WLItemCodeModel: NSCoding {
  ...
  public var payloadJson: WLItemCodePayloadJson?
  ...
  public required init(json: JSON) {
    ...
    payloadJson = WLItemCodePayloadJson(json: json[SerializationKeys.payloadJson])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? WLItemCodePayloadJson
