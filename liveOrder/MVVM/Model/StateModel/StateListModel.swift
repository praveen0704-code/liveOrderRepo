...
public final class StateListModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: SPayloadJson?
  public var headers: SHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = SPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = SHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? SPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? SHeaders
