...
public final class CategoryListModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: CategoryListPayloadJson?
  public var headers: CategoryListHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = CategoryListPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = CategoryListHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? CategoryListPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? CategoryListHeaders
