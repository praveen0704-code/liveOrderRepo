...
public final class WLListModel: NSCoding {
  ...
  public var payloadJson: WLListPayloadJson?
  ...
  public required init(json: JSON) {
    ...
    payloadJson = WLListPayloadJson(json: json[SerializationKeys.payloadJson])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? WLListPayloadJson
