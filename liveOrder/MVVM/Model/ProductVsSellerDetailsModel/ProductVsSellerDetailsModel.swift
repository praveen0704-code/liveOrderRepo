//
//  ProductVsSellerDetailsModel.swift
//
...
public final class ProductVsSellerDetailsModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: ProductVsSellerDetailsPayloadJson?
  public var headers: ProductVsSellerHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = ProductVsSellerDetailsPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = ProductVsSellerHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? ProductVsSellerDetailsPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? ProductVsSellerHeaders
