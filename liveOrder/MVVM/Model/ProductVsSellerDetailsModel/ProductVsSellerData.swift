...
public final class ProductVsSellerData: NSCoding {
  ...
  // MARK: Properties
  public var jList: [ProductVsSellerJList]?
  ...
  public required init(json: JSON) {
    if let items = json[SerializationKeys.jList].array { jList = items.map { ProductVsSellerJList(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    self.jList = aDecoder.decodeObject(forKey: SerializationKeys.jList) as? [ProductVsSellerJList]
