...
public final class FirmUpdateModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: FirmUpdatePayloadJson?
  public var headers: FirmUpdateHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = FirmUpdatePayloadJson(json: json[SerializationKeys.payloadJson])
    headers = FirmUpdateHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? FirmUpdatePayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? FirmUpdateHeaders
