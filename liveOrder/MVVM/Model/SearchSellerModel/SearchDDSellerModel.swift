...
public final class SearchDDSellerModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: SellerDDDataPayloadJson?
  public var headers: SellerDDDataHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = SellerDDDataPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = SellerDDDataHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? SellerDDDataPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? SellerDDDataHeaders
