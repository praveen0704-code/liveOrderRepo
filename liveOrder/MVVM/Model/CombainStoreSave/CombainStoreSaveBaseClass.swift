//
//  CombainStoreSaveBaseClass.swift
//
...
public final class CombainStoreSaveBaseClass: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: CASavePayloadJson?
  public var headers: CASaveHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = CASavePayloadJson(json: json[SerializationKeys.payloadJson])
    headers = CASaveHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? CASavePayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? CASaveHeaders
