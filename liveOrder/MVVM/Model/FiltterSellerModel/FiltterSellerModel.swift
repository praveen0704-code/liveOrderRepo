...
public final class FiltterSellerModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: FiltterSellerPayloadJson?
  public var headers: FiltterSellerHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = FiltterSellerPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = FiltterSellerHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? FiltterSellerPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? FiltterSellerHeaders
