...
public final class FiltterSellerData: NSCoding {
  ...
  // MARK: Properties
  public var jList: [FiltterSellerJList]?
  ...
  public required init(json: JSON) {
    if let items = json[SerializationKeys.jList].array { jList = items.map { FiltterSellerJList(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    self.jList = aDecoder.decodeObject(forKey: SerializationKeys.jList) as? [FiltterSellerJList]
