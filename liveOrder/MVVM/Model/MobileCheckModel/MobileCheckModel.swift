...
public final class MobileCheckModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: MobileCheckPayloadJson?
  public var headers: MobileCheckHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = MobileCheckPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = MobileCheckHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? MobileCheckPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? MobileCheckHeaders
