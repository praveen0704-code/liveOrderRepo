...
public final class GstTypeModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: GstTypePayloadJson?
  public var headers: GstTypeHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = GstTypePayloadJson(json: json[SerializationKeys.payloadJson])
    headers = GstTypeHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? GstTypePayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? GstTypeHeaders
