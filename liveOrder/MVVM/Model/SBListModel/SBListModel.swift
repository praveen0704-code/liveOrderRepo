...
public final class SBListModel: NSCoding {
  ...
  public var payloadJson: SBListPayloadJson?
  ...
  public required init(json: JSON) {
    ...
    payloadJson = SBListPayloadJson(json: json[SerializationKeys.payloadJson])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? SBListPayloadJson
