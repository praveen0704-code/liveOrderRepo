...
public final class AddASellerModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: AddASellerPayloadJson?
  public var headers: AddASellerHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = AddASellerPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = AddASellerHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? AddASellerPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? AddASellerHeaders
