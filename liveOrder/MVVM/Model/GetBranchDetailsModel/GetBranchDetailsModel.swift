...
public final class GetBranchDetailsModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: GetBranchDetailsPayloadJson?
  public var headers: GetBranchDetailsHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = GetBranchDetailsPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = GetBranchDetailsHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? GetBranchDetailsPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? GetBranchDetailsHeaders
