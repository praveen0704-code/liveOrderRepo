...
public final class RequestOtpModel: NSCoding {
  ...
  public var payloadJson: RequestOtpPayloadJson?
  ...
  public required init(json: JSON) {
    ...
    payloadJson = RequestOtpPayloadJson(json: json[SerializationKeys.payloadJson])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? RequestOtpPayloadJson
