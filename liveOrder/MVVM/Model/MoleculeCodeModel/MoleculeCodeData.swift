...
public final class MoleculeCodeData: NSCoding {
  ...
  // MARK: Properties
  public var jList: [MoleculeCodeJList]?
  ...
  public required init(json: JSON) {
    if let items = json[SerializationKeys.jList].array { jList = items.map { MoleculeCodeJList(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    self.jList = aDecoder.decodeObject(forKey: SerializationKeys.jList) as? [MoleculeCodeJList]
