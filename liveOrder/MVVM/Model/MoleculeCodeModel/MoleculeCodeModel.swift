...
public final class MoleculeCodeModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: MoleculeCodePayloadJson?
  public var headers: MoleculeCodeHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = MoleculeCodePayloadJson(json: json[SerializationKeys.payloadJson])
    headers = MoleculeCodeHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? MoleculeCodePayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? MoleculeCodeHeaders
