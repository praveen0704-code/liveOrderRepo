...
public final class MfgWiseProductModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: MfgWiseProductPayloadJson?
  public var headers: MfgWiseProductHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = MfgWiseProductPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = MfgWiseProductHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? MfgWiseProductPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? MfgWiseProductHeaders
