...
public final class MfgWiseProductData: NSCoding {
  ...
  // MARK: Properties
  public var jList: [MfgWiseProductJList]?
  ...
  public required init(json: JSON) {
    if let items = json[SerializationKeys.jList].array { jList = items.map { MfgWiseProductJList(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    self.jList = aDecoder.decodeObject(forKey: SerializationKeys.jList) as? [MfgWiseProductJList]
