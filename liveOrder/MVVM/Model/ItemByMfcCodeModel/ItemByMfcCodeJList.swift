...
public final class ItemByMfcCodeJList: NSCoding {
  ...
  private struct SerializationKeys {
    ...
    static let cContains = "c_content_name"
  ...
  // MARK: Properties
  public var acThumbnailImages: [ItemByMfcCodeAcThumbnailImages]?
  ...
  public required init(json: JSON) {
    if let items = json[SerializationKeys.acThumbnailImages].array { acThumbnailImages = items.map { ItemByMfcCodeAcThumbnailImages(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    self.acThumbnailImages = aDecoder.decodeObject(forKey: SerializationKeys.acThumbnailImages) as? [ItemByMfcCodeAcThumbnailImages]
