//
//  ItemByMfcCodeModel.swift
//
//  Created by Data Prime on 11/12/21
...
public final class ItemByMfcCodeModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: ItemByMfcCodePayloadJson?
  public var headers: ItemByMfcCodeHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = ItemByMfcCodePayloadJson(json: json[SerializationKeys.payloadJson])
    headers = ItemByMfcCodeHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? ItemByMfcCodePayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? ItemByMfcCodeHeaders
