...
public final class TopMostOrderData: NSCoding {
  ...
  // MARK: Properties
  public var jList: [TopMostOrderJList]?
  ...
  public required init(json: JSON) {
    if let items = json[SerializationKeys.jList].array { jList = items.map { TopMostOrderJList(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    self.jList = aDecoder.decodeObject(forKey: SerializationKeys.jList) as? [TopMostOrderJList]
