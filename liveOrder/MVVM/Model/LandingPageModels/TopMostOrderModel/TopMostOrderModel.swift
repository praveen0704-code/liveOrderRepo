...
public final class TopMostOrderModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: TopMostOrderPayloadJson?
  public var headers: TopMostOrderHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = TopMostOrderPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = TopMostOrderHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? TopMostOrderPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? TopMostOrderHeaders
