...
public final class LimitedOffersModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: LimitedOffersPayloadJson?
  public var headers: LimitedOffersHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = LimitedOffersPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = LimitedOffersHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? LimitedOffersPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? LimitedOffersHeaders
