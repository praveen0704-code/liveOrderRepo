...
public final class LimitedOffersData: NSCoding {
  ...
  // MARK: Properties
  public var jList: [LimitedOffersJList]?
  ...
  public required init(json: JSON) {
    if let items = json[SerializationKeys.jList].array { jList = items.map { LimitedOffersJList(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    self.jList = aDecoder.decodeObject(forKey: SerializationKeys.jList) as? [LimitedOffersJList]
