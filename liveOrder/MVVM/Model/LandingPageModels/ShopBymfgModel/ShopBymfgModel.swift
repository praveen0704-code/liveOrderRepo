...
public final class ShopBymfgModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: ShopMfgPayloadJson?
  public var headers: ShopMfgHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = ShopMfgPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = ShopMfgHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? ShopMfgPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? ShopMfgHeaders
