...
public final class BannerModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: BPayloadJson?
  public var headers: BHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = BPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = BHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? BPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? BHeaders
