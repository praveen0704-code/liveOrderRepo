...
public final class NewLaunchModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: NewLaunchPayloadJson?
  public var headers: NewLaunchHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = NewLaunchPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = NewLaunchHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? NewLaunchPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? NewLaunchHeaders
