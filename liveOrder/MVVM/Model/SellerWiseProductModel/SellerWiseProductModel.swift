...
public final class SellerWiseProductModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: SellerWiseProductPayloadJson?
  public var headers: SellerWiseProductHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = SellerWiseProductPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = SellerWiseProductHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? SellerWiseProductPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? SellerWiseProductHeaders
