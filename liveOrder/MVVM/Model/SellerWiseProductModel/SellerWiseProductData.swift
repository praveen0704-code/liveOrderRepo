...
public final class SellerWiseProductData: NSCoding {
  ...
  // MARK: Properties
  public var jList: [SellerWiseProductJList]?
  ...
  public required init(json: JSON) {
    if let items = json[SerializationKeys.jList].array { jList = items.map { SellerWiseProductJList(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    self.jList = aDecoder.decodeObject(forKey: SerializationKeys.jList) as? [SellerWiseProductJList]
