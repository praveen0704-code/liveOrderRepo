...
public final class SearchByMFGData: NSCoding {
  ...
  // MARK: Properties
  public var jList: [SearchByMFGJList]?
  ...
  public required init(json: JSON) {
    if let items = json[SerializationKeys.jList].array { jList = items.map { SearchByMFGJList(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    self.jList = aDecoder.decodeObject(forKey: SerializationKeys.jList) as? [SearchByMFGJList]
