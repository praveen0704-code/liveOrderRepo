...
public final class SearchByMFGModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: SearchByMFGPayloadJson?
  public var headers: SearchByMFGHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = SearchByMFGPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = SearchByMFGHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? SearchByMFGPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? SearchByMFGHeaders
