...
public final class FiltterBrandModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: FiltterBrandPayloadJson?
  public var headers: FiltterBrandHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = FiltterBrandPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = FiltterBrandHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? FiltterBrandPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? FiltterBrandHeaders
