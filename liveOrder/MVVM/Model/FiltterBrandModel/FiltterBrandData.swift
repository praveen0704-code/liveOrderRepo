...
public final class FiltterBrandData: NSCoding {
  ...
  // MARK: Properties
  public var jList: [FiltterBrandJList]?
  ...
  public required init(json: JSON) {
    if let items = json[SerializationKeys.jList].array { jList = items.map { FiltterBrandJList(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    self.jList = aDecoder.decodeObject(forKey: SerializationKeys.jList) as? [FiltterBrandJList]
