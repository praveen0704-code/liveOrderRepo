...
public final class SInspiredBaseClass: NSCoding {
      ...
      // MARK: Properties
      public var payloadJson: SInspiredPayloadJson?
      public var headers: SInspiredHeaders?
      ...
      public required init(json: JSON) {
        payloadJson = SInspiredPayloadJson(json: json[SerializationKeys.payloadJson])
        headers = SInspiredHeaders(json: json[SerializationKeys.headers])
      ...
      required public init(coder aDecoder: NSCoder) {
        self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? SInspiredPayloadJson
        self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? SInspiredHeaders
