...
public final class SInspiredData: NSCoding {
  ...
  // MARK: Properties
  public var jList: [SInspiredJList]?
  ...
  public required init(json: JSON) {
    if let items = json[SerializationKeys.jList].array { jList = items.map { SInspiredJList(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    self.jList = aDecoder.decodeObject(forKey: SerializationKeys.jList) as? [SInspiredJList]
