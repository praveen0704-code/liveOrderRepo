...
public final class ItemBySellerFiltterData: NSCoding {
  ...
  // MARK: Properties
  public var jList: [ItemBySellerFiltterJList]?
  ...
  public required init(json: JSON) {
    if let items = json[SerializationKeys.jList].array { jList = items.map { ItemBySellerFiltterJList(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    self.jList = aDecoder.decodeObject(forKey: SerializationKeys.jList) as? [ItemBySellerFiltterJList]
