//
//  ItemBySellerFiltterModel.swift
//
...
public final class ItemBySellerFiltterModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: ItemBySellerFiltterPayloadJson?
  public var headers: ItemBySellerFiltterHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = ItemBySellerFiltterPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = ItemBySellerFiltterHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? ItemBySellerFiltterPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? ItemBySellerFiltterHeaders
