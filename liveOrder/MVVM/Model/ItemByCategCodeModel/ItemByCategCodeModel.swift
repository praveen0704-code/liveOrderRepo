...
public final class ItemByCategCodeModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: ItemByCategCodePayloadJson?
  public var headers: ItemByCategCodeHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = ItemByCategCodePayloadJson(json: json[SerializationKeys.payloadJson])
    headers = ItemByCategCodeHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? ItemByCategCodePayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? ItemByCategCodeHeaders
