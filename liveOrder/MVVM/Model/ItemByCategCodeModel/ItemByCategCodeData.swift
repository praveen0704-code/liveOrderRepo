...
public final class ItemByCategCodeData: NSCoding {
  ...
  // MARK: Properties
  public var jList: [ItemByCategCodeJList]?
  ...
  public required init(json: JSON) {
    if let items = json[SerializationKeys.jList].array { jList = items.map { ItemByCategCodeJList(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    self.jList = aDecoder.decodeObject(forKey: SerializationKeys.jList) as? [ItemByCategCodeJList]
