...
public final class CombainStoreNABaseClass: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: ComPayloadJson?
  public var headers: ComHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = ComPayloadJson(json: json[SerializationKeys.payloadJson])
    headers = ComHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? ComPayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? ComHeaders
