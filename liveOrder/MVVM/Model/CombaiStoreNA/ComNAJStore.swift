...
public final class ComJStore: NSCoding {
  ...
  private struct SerializationKeys {
    ...
    static let cEmailId = "c_email_id"
  }
  ...
  public required init(json: JSON) {
    ...
    cEmailId = json[SerializationKeys.cEmailId].string
  }
  ...
  public func dictionaryRepresentation() -> [String: Any] {
    ...
    if let value = cEmailId { dictionary[SerializationKeys.cEmailId] = value }
    return dictionary
  }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.cEmailId = aDecoder.decodeObject(forKey: SerializationKeys.cEmailId) as? String
  }
  ...
  public func encode(with aCoder: NSCoder) {
    ...
    aCoder.encode(cEmailId, forKey: SerializationKeys.cEmailId)
  }
