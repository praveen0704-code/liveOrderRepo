//
//  PriorityBaseClass.swift
//
//  Created by PraveenMac on 06/02/22
...
public final class PriorityBaseClass: NSCoding {
  ...
  // MARK: Properties
  public var headers: PriorityHeaders?
  ...
  public required init(json: JSON) {
    headers = PriorityHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? PriorityHeaders
