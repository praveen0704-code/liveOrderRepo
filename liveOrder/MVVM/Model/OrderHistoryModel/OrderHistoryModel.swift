...
public final class OrderHistoryModel: NSCoding {
  ...
  public var payloadJson: OrderHistoryPayloadJson?
  ...
  public required init(json: JSON) {
    ...
    payloadJson = OrderHistoryPayloadJson(json: json[SerializationKeys.payloadJson])
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? OrderHistoryPayloadJson
