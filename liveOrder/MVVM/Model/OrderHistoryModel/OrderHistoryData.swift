...
public final class OrderHistoryData: NSCoding {
  ...
  // MARK: Properties
  public var jList: [OrderHistoryJList]?
  ...
  public required init(json: JSON) {
    if let items = json[SerializationKeys.jList].array { jList = items.map { OrderHistoryJList(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    self.jList = aDecoder.decodeObject(forKey: SerializationKeys.jList) as? [OrderHistoryJList]
