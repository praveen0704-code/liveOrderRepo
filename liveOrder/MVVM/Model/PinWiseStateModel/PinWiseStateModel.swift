...
public final class PinWiseStateModel: NSCoding {
  ...
  // MARK: Properties
  public var payloadJson: PinWiseStatePayloadJson?
  public var headers: PinWiseStateHeaders?
  ...
  public required init(json: JSON) {
    payloadJson = PinWiseStatePayloadJson(json: json[SerializationKeys.payloadJson])
    headers = PinWiseStateHeaders(json: json[SerializationKeys.headers])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.payloadJson = aDecoder.decodeObject(forKey: SerializationKeys.payloadJson) as? PinWiseStatePayloadJson
    self.headers = aDecoder.decodeObject(forKey: SerializationKeys.headers) as? PinWiseStateHeaders
