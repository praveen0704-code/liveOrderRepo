...
open class BubbleTabBar: UITabBar {
    ...
    private func addShape() {
          ...
          //  shapeLayer.strokeColor = UIColor.gray.withAlphaComponent(0.0).cgColor
    ...
    open override func layoutSubviews() {
            ...
            tabFrame.size.height    = 97 + (UIApplication.shared.keyWindow?.safeAreaInsets.bottom ?? CGFloat.zero)
            tabFrame.origin.y       = self.frame.origin.y +   ( self.frame.height - 97 - (UIApplication.shared.keyWindow?.safeAreaInsets.bottom ?? CGFloat.zero))
